...
import { productSchema, multipleProductSchema } from "../validation/productValidation";
...
const multipleValidateRequest = async (req: Request, res: Response, next: NextFunction) => {
    try {
